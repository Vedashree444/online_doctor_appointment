...
<?php
  ...
  $query = "SELECT patientname, email,age, gender, doctorname, date, time, meet FROM patientdetails";
  ...
  if($num_rows > 0){
    while($row = $result->fetch_assoc()){
     echo "<tr><td>". $row["patientname"]."</td><td>". $row["email"]. "</td><td>".$row["age"]. "</td><td>". $row["gender"]."</td><td>". $row["doctorname"]. "</td><td>". $row["date"]. "</td><td>". $row["time"]. "</td><td>". $row["meet"]. "</td></tr>";
