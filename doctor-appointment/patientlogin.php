<?php
 ...
 $query = "SELECT patientname FROM patientdetails WHERE email = '$email' AND password = '$password'";
...
<link rel="stylesheet" href="my.css">
	...
	<img src = "images/doctorts.jpg" height= "150px" width ="500px" atl="image not found"/>
	
	<h2><i>Welcome to online doctor appointment</i></h2>
        <h2>incorrect userid or password<h2>
        <a href = patient.html> ok </a>
