...
<?php
  ...
  $query = "SELECT doctorname, email, catagory, phoneno, age, gender, fees, timing, experience FROM doctor_details";
  ...
  if($num_rows > 0){
    ...
    echo "<tr><td>". $row["doctorname"]."</td><td>". $row["email"]. "</td><td>".$row["catagory"]. "</td><td>". $row["phoneno"]. "</td><td>". $row["age"]. "</td><td>". $row["gender"]. "</td><td>". $row["fees"]. "</td><td>". $row["timing"]. "</td><td>". $row["experience"]. "</td><td>";
